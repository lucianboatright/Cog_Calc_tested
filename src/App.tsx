          ...
          <CrankProvider>
            {/* <WheelProvider > */}
              ...
              <div className="Main_Body">
                ...
                <WheelIndex childToParentWheel={childToParentWheel}/>
                <TyreIndex childToParentTyre={childToParentTyre} />
                <div className="Detials">
                  <Details wheelSize={wheelDataState} tyreText={tyreDataState} />
                </div>
              </div>
            {/* </WheelProvider> */}
          </CrankProvider>
